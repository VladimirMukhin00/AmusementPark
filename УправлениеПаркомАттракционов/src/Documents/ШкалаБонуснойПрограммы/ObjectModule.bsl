...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Диапазоны[0].НижняяГраницаПродаж <> 0 Тогда
				Отказ = Истина;
	...
	Для Сч = 0 По Диапазоны.Количество() - 1 Цикл
		...
		Если Сч > 0 Тогда
				Если Диапазон.НижняяГраницаПродаж <> ВерхняяГраницаПредыдущегоДиапазона Тогда
		...
		Если Диапазон.НижняяГраницаПродаж >= Диапазон.ВерхняяГраницаПродаж 
		...
		ВерхняяГраницаПредыдущегоДиапазона = Диапазон.ВерхняяГраницаПродаж;
		
	КонецЦикла;
	
	ПоследнийДиапазон = Диапазоны[Диапазоны.Количество() - 1];
	
	Если ПоследнийДиапазон.ВерхняяГраницаПродаж <> 0 Тогда
				Отказ = Истина;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = СтрШаблон("Нижняя граница первого диапазона должна быть равна 0");
				Сообщение.УстановитьДанные(ЭтотОбъект);
